...
func init() {
	...
	utilruntime.Must(qiujian16githubcomv1.AddToScheme(scheme))
...
func main() {
	...
	// Create dynamic client for arbitrary resource operations
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:       "ff6b8473.qiujian16.github.com",
